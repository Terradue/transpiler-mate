...
LICENSES_INDEX: Mapping[str, CreativeWork] = {
  ...
  'HPND-sell-variant-critical-systems': CreativeWork(
    ...
    url=AnyUrl('https://gitlab.freedesktop.org/xorg/driver/xf86-video-voodoo/-/blob/68a5b6d98ae34749cca889f4373b4043d00bfe6a/src/voodoo_dga.c#L12-33')
  ), # type: ignore
  ...
  'ISO-permission': CreativeWork(
    ...
    url=AnyUrl('https://gitlab.com/agmartin/linuxdoc-tools/-/blob/master/iso-entities/COPYING?ref_type=heads')
  ), # type: ignore
  ...
  'MIT-STK': CreativeWork(
    ...
    url=AnyUrl('https://github.com/thestk/stk/blob/6aacd357d76250bb7da2b1ddf675651828784bbc/LICENSE')
  ), # type: ignore
  ...
  'MMPL-1.0.1': CreativeWork(
    ...
    url=AnyUrl('https://github.com/BuildCraft/BuildCraft/blob/623d323b1868712f29f4a8b0979a02e8d1835131/LICENSE')
  ), # type: ignore
  ...
  'OpenMDW-1.0': CreativeWork(
    ...
    url=AnyUrl('https://raw.githubusercontent.com/OpenMDW/OpenMDW/refs/heads/main/1.0/LICENSE.openmdw')
  ), # type: ignore
  ...
  'ParaType-Free-Font-1.3': CreativeWork(
    ...
    url=AnyUrl('https://web.archive.org/web/20161209023955/http://www.paratype.ru/public/pt_openlicense_eng.asp')
  ), # type: ignore
  ...
  'TekHVC': CreativeWork(
    identifier='TekHVC',
    name='TekHVC License',
    url=AnyUrl('https://gitlab.freedesktop.org/xorg/lib/libx11/-/blob/master/COPYING?ref_type=heads#L138-171')
  ), # type: ignore
  ...
  'UnRAR': CreativeWork(
    identifier='UnRAR',
    name='UnRAR License',
    url=AnyUrl('https://public.dhe.ibm.com/aix/freeSoftware/aixtoolbox/LICENSES/unRAR.txt')
  ), # type: ignore
  ...
  'Vixie-Cron': CreativeWork(
    ...
    url=AnyUrl('https://github.com/vixie/cron/tree/545b3f5246824a9cda5905eeb7cf019c95e66995')
  ), # type: ignore
  ...
  'X11-no-permit-persons': CreativeWork(
    ...
    url=AnyUrl('https://gitlab.freedesktop.org/xorg/lib/libxinerama/-/blob/cc22c2f60c3862482562955116d5455263b443dc/COPYING#L44-66')
  ), # type: ignore
